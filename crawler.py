...
def download(download_url):
    ...
    # 开启网络日志: https://stackoverflow.com/questions/56507652/selenium-chrome-cant-see-browser-logs-invalidargumentexception
    ...
    try:
        ...
        # Todo: 等待并不能完全解决 element not interactable
        sleep(2)
        element.click()
        # 等待下载完成以及网络日志
        sleep(2)
...
if __name__ == '__main__':
    # Word: https://www.docer.com/s/wps/?page=
    # PPT: https://www.docer.com/s/wpp/?page=
    # Excel: https://www.docer.com/s/et/?page=
